          ...
          <div className="p-4 rounded-xl border border-brand-border bg-white space-y-3">
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">Include translated captions (SRT)</span>
              </div>
              {isPaid ? (
                <input
                  type="checkbox"
                ...
                <span className="text-[10px] bg-brand-primary/10 text-brand-primary px-2 py-0.5 rounded-full font-medium">Pro</span>
              )}
            </label>
            <label className="flex items-center justify-between cursor-pointer">
              <div className="flex items-center gap-2">
